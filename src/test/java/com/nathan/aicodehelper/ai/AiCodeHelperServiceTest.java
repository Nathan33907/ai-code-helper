...
class AiCodeHelperServiceTest {
    ...
    @Test
    void chat() {
        String result = aiCodeHelperService.chat("你好，我是程序员Nathan");
    ...
    @Test
    void chatForReport() {
        String userMessage = "你好，我是Nathan，学编程两年半，请帮我制定学习报告";
    ...
    @Test
    void chatWithRag() {
        Result<String> result = aiCodeHelperService.chatWithRag("你好，怎么学习Java？有哪些常见的面试题？");
